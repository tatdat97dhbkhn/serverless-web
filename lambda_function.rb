...
def setup_driver
  service = Selenium::WebDriver::Service.chrome(path: '/var/task/bin/chromedriver')
  Selenium::WebDriver.for :chrome, service: service, options: driver_options
end

def driver_options
  options = Selenium::WebDriver::Chrome::Options.new(binary: '/var/task/bin/headless-chromium')
